    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('abandoned', 'Abandoned'), ('completed', 'Completed')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='CustomToken',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ManyToManyField(blank=True, related_name='carts', to='user_auth.product')),
            ],
        ),
    ]
